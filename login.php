...
<html>
	<head>
        ...
        ?>
		<title>Login | Quiz Management Portal Nbyula</title>
	</head>

	<body id='login-body' class="bg-light">

        <div class="card col-md-6 offset-md-3 text-center bg-primary mb-4">
            <h3 class="he3-responsive text-white">Quiz Management Portal Nbyula Assignment</h3>
					</div>
			<div style="background-color:yellow" class="card col-md-4 offset-md-4 mt-4">
	        <div class="card-header-edge text-white">
	                    <strong>Login</strong><br>User- admin<br>Pass- devashish
	                </div>
